...
public class PropertiesUtil {
    ...
    /**
     * Sets properties from the config if props doesn't have them already
     */
    public static void addMissingPropertiesFromConfig(Properties props, Configuration conf) {
        Iterator<Map.Entry<String, String>> iterator = conf.iterator();
        if(iterator != null) {
            while (iterator.hasNext()) {
                Map.Entry<String, String> entry = iterator.next();
