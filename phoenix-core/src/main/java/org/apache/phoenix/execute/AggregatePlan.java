    ...
    protected ResultIterator newIterator() throws SQLException {
        if (groupBy.isEmpty()) {
            ...
            if (limit != null
                    ...
                    && having == null
                    && ((statement.isDistinct() && !statement.isAggregate()) || (!statement
                            .isDistinct() && (context.getAggregationManager().isEmpty() || BaseScannerRegionObserver.KEY_ORDERED_GROUP_BY_EXPRESSIONS
                ...
                context.getScan().setAttribute(BaseScannerRegionObserver.GROUP_BY_LIMIT,
                    PDataType.INTEGER.toBytes(limit));
            }
        }
