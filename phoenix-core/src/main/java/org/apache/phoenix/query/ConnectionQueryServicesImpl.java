...
public class ConnectionQueryServicesImpl extends DelegateQueryServices implements ConnectionQueryServices {
    ...
    private HTableDescriptor ensureTableCreated(byte[] physicalTableName, PTableType tableType, Map<String, Object> props,
        ...
        try (HBaseAdmin admin = getAdmin()) {
            ...
            tableExist = admin.tableExists(physicalTableName);
            try {
                existingDesc = admin.getTableDescriptor(physicalTableName);
            } catch (org.apache.hadoop.hbase.TableNotFoundException e) {
                if (tableExist && SchemaUtil.isSystemTable(physicalTableName)) {
            ...
            if (accessDeniedToSystemTable) {
                logger.debug("Unable to confirm the descriptor of " + Bytes.toString(physicalTableName)
