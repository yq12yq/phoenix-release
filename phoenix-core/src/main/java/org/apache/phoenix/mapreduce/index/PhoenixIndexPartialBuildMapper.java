            ...
            for (Cell cell : value.rawCells()) {
                if (KeyValue.Type.codeToType(cell.getTypeByte()) == KeyValue.Type.Put) {
                    if (put == null) {
                        ...
                        put.setAttribute(BaseScannerRegionObserver.REPLAY_WRITES, PDataType.TRUE_BYTES);
                        mutations.add(put);
                    }
                    put.add(cell);
                } else {
                    if (del == null) {
                        ...
                        del.setAttribute(BaseScannerRegionObserver.REPLAY_WRITES, PDataType.TRUE_BYTES);
                        mutations.add(del);
                    }
