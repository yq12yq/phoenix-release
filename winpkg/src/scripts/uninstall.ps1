...
{
    Write-Log "Uninstalling Apache Phoenix phoenix-@phoenix.version@"
    Uninstall "phoenix" $ENV:HADOOP_NODE_INSTALL_ROOT
    Write-Log "Finished Uninstalling Apache Phoenix"
}
